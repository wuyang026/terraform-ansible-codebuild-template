...
with open("inventory/hosts", "w") as f:
    ...
    f.write("\n[dbservers:vars]\n")
    f.write("ansible_connection=amazon.aws.aws_ssm\n")
    ...
    f.write("ansible_aws_ssm_plugin=/usr/local/bin/session-manager-plugin\n")
    f.write("ansible_python_interpreter=/usr/bin/python3\n")
    f.write("remote_tmp=/tmp/.ansible/tmp\n")
    f.write("ansible_remote_tmp=/tmp/.ansible/tmp\n")
    f.write("local_tmp=/tmp/.ansible/localtmp\n")